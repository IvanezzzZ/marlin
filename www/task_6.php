            ...
            <div class="row js-list-filter" id="js-contacts">
                ...
                $users = [
                    [
                        ...
                        'tel_href' => '+13174562564',
                        'tel_link' => ' +1 317-456-2564',
                        'email_href' => 'mailto:oliver.kopyov@smartadminwebapp.com',
                        'email_link' => ' oliver.kopyov@smartadminwebapp.com',
                        'home_address' => ' 15 Charist St, Detroit, MI, 48212, USA',
                    ],
                    [
                        'id' => 'c_2',
                        'tag' => 'sesha gray',
                        ...
                        'tel_href' => '+13174562564',
                        'tel_link' => ' +1 313-461-1347',
                        'email_href' => 'mailto:oliver.kopyov@smartadminwebapp.com',
                        'email_link' => ' sesha.gray@smartadminwebapp.com',
                        'home_address' => ' 134 Hamtrammac, Detroit, MI, 48314, USA',
                    ],
                    [
                        'id' => 'c_3',
                        'tag' => 'dr john cook',
                        ...
                        'tel_href' => '+13174562564',
                        'tel_link' => ' +1 313-779-1347',
                        'email_href' => 'mailto:oliver.kopyov@smartadminwebapp.com',
                        'email_link' => ' john.cook@smartadminwebapp.com',
                        'home_address' => ' 55 Smyth Rd, Detroit, MI, 48341, USA',
                    ],
                    [
                        'id' => 'c_4',
                        'tag' => 'jim ketty',
                        ...
                        'tel_href' => '+13174562564',
                        'tel_link' => ' +1 313-779-3314',
                        'email_href' => 'mailto:oliver.kopyov@smartadminwebapp.com',
                        'email_link' => ' jim.ketty@smartadminwebapp.com',
                        'home_address' => ' 134 Tasy Rd, Detroit, MI, 48212, USA',
                    ]
                ];
                ...
                <div class="col-xl-4">
                    <div id="<?= $user['id'] ?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?= $user['tag'] ?>">
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:<?= $user['tel_href'] ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i><?= $user['tel_link'] ?></a>
                                <a href="<?= $user['email_href'] ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i><?= $user['email_link'] ?></a>
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i><?= $user['home_address'] ?></address>
